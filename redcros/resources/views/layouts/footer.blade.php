  ...
  <footer id="footer">
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <h3><a href="{{ url('/') }}" class="logo me-auto" style="color:white"><img src="frontend/assets/img/logo.png" alt="" class="" width="50px">Redcross</img></a></h3>            <p>
              Rajkot-360002 <br>
              gujrat<br>
              India <br><br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Register Donor</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div class="credits">
          Designed by <h3><a href="{{ url('/') }}" class="logo me-auto"><img src="frontend/assets/img/logo.png" alt="" class="" width="50px">Redcross</img></a></h3>


        </div>
      </div>
      <div class="social-links text-center text-md-right pt- pt-md-0">
