...
<section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
          <h3 style="color:red">About Blood Doners</h3>
          <br/>
          <p>Giving blood saves lives. The blood you give is a lifeline in an emergency and for people who need long-term treatments.</p>
                    ...
                    <br/>
                    <p>We need over more blood donations every day to treat patients in need across india. Which is why there’s always a need for people to give blood.</p>
                    <br/>
                    <p>Each year we need approximately More new donors, as some donors can no longer give blood.</p>
                    <br/>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <img src="frontend/assets/img/about.png" alt="">
