  ...
  <div class="page-container">
    ...
    <div class="sidebar-menu">
      <div class="sidebar-header">
        ...
        <h1 style="margin-right:50px"><a href="{{'/admin/index'}}" class="mainmenu">Redcross</a></h1>
     <!--logo-->
		</div>
      </div>
      <div class="main-menu">
        <div class="menu-inner">
          <nav>
            <ul class="metismenu" id="menu">
             <li>
                <a href="{{'/admin/index'}}" aria-expanded="true">
              ...
              <li>
                ...
                <ul class="collapse">
                  ...
                  <li><a href="{{ url('/admin/index/add_bloodgroup') }}">Add bloodgroup</a></li>
                </ul>
              </li>
              ...
              <li>
                ...
                <i class="fa fa-users"></i>
                  <span>Donors details</span>
                </a>
                <ul class="collapse">
                  <li><a href="{{ url('/admin/donordetails')}}"><i class="fa fa-users"></i> Manage Donors</a></li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul class="collapse">
                  <li><a href="{{ url('/admin/userdetails') }}"> Manage User</a></li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul class="collapse">
                  <li><a href="{{ url('/admin/contactdetails') }}">Manage contact user</a></li>
                </ul>
              </li>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-6 clearfix">
            <div class="user-profile pull-right">
              <img class="avatar user-thumb" src="{{ url('admin/assets/images/author/avatar.jpg') }}" alt="avatar" />
